...
dat <- read.csv("combo.dat.2024.all.plots.trait.means.5.26.25.csv")
...
##export data
fwrite(plot.dat, "C:/Users/maria/Desktop/Research/2024/processed_df/plot.dat.5.26.25.csv")
fwrite(phys.dat, "C:/Users/maria/Desktop/Research/2024/processed_df/phys.dat.5.26.25.csv")
fwrite(species.dat, "C:/Users/maria/Desktop/Research/2024/processed_df/species.dat.5.26.25.csv")
